% Compression of an audio file using MDCT filter bank,
...
disp(['The compression rate is ' num2str(original_size/coded_size)]);
...
[~, fn, ~] = fileparts(inputFile);
audiowrite(['./data/' fn '_decoded.wav'],x_decoded, fs);
